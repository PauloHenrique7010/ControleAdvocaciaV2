  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Alterar advogado</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <?php            
                    echo form_open('Admin/AlterarAdvogado/'.$registros->cod_advogado,'',array('cod_advogado'=>$registros->cod_advogado)); 
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <?php 
                        echo form_input(array(  'name'  => 'nome_advogado',
                                                'maxlength' => 50,
                                                'autofocus' => 'autofocus',
                                                'class' => 'form-control',
                                                'placeholder'=>'Exemplo: OAB, CREA, CRECI'), 
                                                set_value('nome_advogado',$registros->nome_advogado));
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
