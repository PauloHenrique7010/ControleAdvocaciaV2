  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Configuração Escavador API</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <?php            
                    echo form_open('Admin/ConfiguracaoEscavador/Confirmar','',); 
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <?php 
                        echo form_textarea(array( 'name'  => 'access_token',
                                                  'autofocus' => 'autofocus',
                                                  'class' => 'form-control'),
                                                  set_value('access_token',$registro->access_token));
                    ?>
                  </div>
                  <div class="form-group">
                    <label>Token refresh</label>
                    <?php 
                        echo form_textarea(array( 'name'  => 'refresh_token',
                                                  'autofocus' => 'autofocus',
                                                  'class' => 'form-control'),
                                                  set_value('refresh_token',$registro->refresh_token));
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
