  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Alterar profissão</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <?php           
                    echo form_open('Admin/AlterarProfissao/'.$registros->cod_profissao,'',array('cod_profissao'=>$registros->cod_profissao)); 
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <?php 
                        echo form_input(array(  'name'  => 'nome_profissao',
                                                'maxlength' => 50,
                                                'autofocus' => 'autofocus',
                                                'class' => 'form-control',
                                                'placeholder'=>'Exemplo: Professor(a), Cozinheiro(a)'), 
                                                set_value('nome_profissao',$registros->nome_profissao));
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
