...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if (URLAtual.indexOf("Novo") == -1) {
            ...
            $.ajax({
                ...
                if (response.status == 200)
                    $("#edtNomeTipoProcesso").val(resposta.registros[0].nome_tipo_processo)
                else {
        ...
        function Confirmar(event) {
            ...
            if (nomeTipoProcesso == "") {
                msgConfirmacao += "Informe o nome do tipo do processo<br>";
                OPConfirmar = false;
            }
            if (OPConfirmar == false) {
                ...
                $.ajax({
                    ...
                    if (response.status != 200)
                        ...
                        window.location.href = "http://localhost/ControleAdvocaciaV2/Admin/TipoProcesso"; //voltar para a pagina inicial                  
                }).fail(function(jqXHR, status, err) {
                    exibirMensagemErro(jqXHR.responseJSON.title, jqXHR.responseJSON.message);
                });
            }
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Cadastrar tipo processo</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nome tipo processo</label>
                                <input type="text" id="edtNomeTipoProcesso" class="form-control" placeholder="Exemplo: Cívil" maxlength="30" autofocus="autofocus">
                            </div>
                        </div>
                        <!-- /.card-body -->
