  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Alterar orgão de classe</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Orgão classe</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <?php            
                    echo form_open('Admin/AlterarOrgaoClasse/'.$registros->cod_orgao_classe,'',array('cod_orgao_classe'=>$registros->cod_orgao_classe)); 
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Nome do orgão de classe</label>
                    <?php 
                        echo form_input(array(  'name'  => 'nome_orgao_classe',
                                                'maxlength' => 50,
                                                'autofocus' => 'autofocus',
                                                'class' => 'form-control',
                                                'placeholder'=>'Exemplo: OAB, CREA, CRECI'), 
                                                set_value('nome_orgao_classe',$registros->nome_orgao_classe));
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
