  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Alterar foro</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <?php            
                    echo form_open('Admin/AlterarForo/'.$registros->cod_foro,'',array('cod_foro'=>$registros->cod_foro)); 
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Nome do foro</label>
                    <?php 
                        echo form_input(array(  'name'  => 'nome_foro',
                                                'maxlength' => 50,
                                                'autofocus' => 'autofocus',
                                                'class' => 'form-control'),
                                                set_value('nome_foro',$registros->nome_foro));
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
