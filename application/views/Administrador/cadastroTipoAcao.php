...
<script>
  $(document).ready(function() {
    ...
    $('#tabelaTipoAcao').on('click', 'tbody tr .btnAlterar', function(e){
      let codigo = $(this).data("codigo");
      var dados = JSON.stringify(codigo);
      sessionStorage.setItem('codTipoAcao', dados );
    })
      ...
      $.ajax({
        ...
        $.each(resposta.registros, function(index, data) {
          dataSet.push([
            data.cod_tipo_acao,
            data.nome_tipo_acao,
            '<a href="<?php echo base_url("Admin/AlterarTipoAcao/"); ?>"><button type="button" class="btn btn-warning btnAlterar" data-codigo="' + data.cod_tipo_acao + '">Alterar</button></a> &nbsp;&nbsp;' +
