    ...
    $(document).ready(function() {
      ...
      $('#enviar').on('click', function(e){
        ...
        function validar(e){
            ...
            if (numCel == 0){
                msgValidacao += "Informe pelo meno um telefone para contato";            
            }
...
<div class="container">
    ...
    <?php  
        $codCliente         = sprintf("%03d", $cliente->cod_cliente); //formata para 000
        $nomeCliente        = $cliente->nome_cliente;
        if ($cliente->data_nascimento > 0){
        ...
        $codEstadoCivil     = $cliente->cod_estado_civil;
        $codProfissao       = $cliente->cod_profissao;
        $codOrgaoClasse     = $cliente->cod_orgao_classe;
        $cep                = $cliente->cep;
        $num                = $cliente->numero;
        ...
        $codBanco           = $cliente->cod_banco;
        $numAgencia         = $cliente->num_agencia;
        $numConta           = $cliente->num_conta;
        $codTipoConta       = $cliente->cod_tipo_conta;
        $descricaoCliente   = converterBancoParaTagHTML($cliente->descricao_cliente);        
           
        echo form_open('EditarCliente/'.$cliente->cod_cliente,'',array('cod_cliente'=>$codCliente)); 
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-8">
                ...
                <?php                        
                        echo form_input(array(  'id'    => 'nome_cliente',
                                                ...
                                                'autofocus' => 'autofocus',
                                                'class' => 'form-control'), 
                                                set_value('nome_cliente',$nomeCliente));                
            ...
            <div class="col-md-2">
                ...
                <?php
                    echo form_input(array(  'id'    => 'data_nascimento',
                                            ...
                                            set_value('data_nascimento',$dataNascimento));                          
                ?>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-4">
                ...
                <?php
                    echo form_dropdown(array( 'class'=>'form-control',
                                                ...
                                                $estado_civil,
                                                set_value('cod_estado_civil',$codEstadoCivil));
                ?>
            </div>
            <div class="col-md-4">
                <h4>Profissão</h4>
                <?php
                    echo form_dropdown(array( 'class'=>'form-control',
                                                'name'=>'cod_profissao'),
                                                $profissoes,
                                                set_value('cod_profissao',$codProfissao));
                ?>
            </div>
            <div class="col-md-4">
                ...
                <?php
                    echo form_dropdown(array(   'class'=>'form-control',
                                                ...
                                                $orgao_classe,
                                                set_value('cod_orgao_classe',$codOrgaoClasse));
                ?>               
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <?php 
                    echo form_input(array(  'id'    => 'complemento',
                                            ...
                                            set_value('complemento',$complemento));
                ?>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4>Agência</h4>
                <?php
                    echo form_input(array(  'id'    => 'num_agencia',
                                            'name'  => 'num_agencia',
                                            'class' => 'form-control',
                                            'maxlength' => 20), 
                                            set_value('num_agencia',$numAgencia));
                ?>
            </div>
            <div class="col-md-6">
                <h4>Conta</h4>
            ...
            <div class="col-md-12">
                ...
                <?php
                    echo form_dropdown(array( 'class'=>'form-control',
                                                'name'=>'cod_tipo_conta'),
                                                $tipo_conta_banco,
                                                set_value('cod_tipo_conta',$codTipoConta));
                ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    echo form_textarea(array(   'name'=>'descricao_cliente',
                                                'id' => 'summernote',
                                                'class' => 'editorhtml'),
                                                set_value('descricao_cliente',$descricaoCliente,false)); //ultimo parametro é para interpretar html tags
                ?>
            </div>
        </div>
    </div>
